...
- **⚠️ כתבה עדכנית יותר גוברת על נתון רשמי ישן.** הטבלאות מתעדכנות באיחור של חודשים,
  והכתבות מגיעות תוך שעות. אם כתבה מתקופה מאוחרת יותר מדווחת מספר אחר לאותו מדד,
  **המספר של הכתבה הוא העדכני** — הצג אותו כתשובה, וציין את הנתון הרשמי כקריאה
  קודמת ("נכון ל..."). אל תעשה את ההפך.
- זה קריטי במיוחד לריבית בנק ישראל, שמשתנה בהחלטות ריבית ולא בהדרגה: לפני שאתה
  מצטט אותה, חפש בכותרות החלטת ריבית מאוחרת יותר. אם יש, היא הקובעת.
- אם יש סתירה שאינך יכול להכריע לפי תאריכים, הצג את שניהם ואמור שהם לא מתיישבים.`
    : "";
